...
subject_list=($(cat ~/scratch/BRS_subset/present_subjects.tsv)) # MODIFY
SUB="${subject_list[$((SLURM_ARRAY_TASK_ID-1))]}"

# Run Python script for this subject
python ~/scratch/BRS_Training_Dev/process_one_subject.py "$SUB" # TO DO CHANGE THIS BACK TO BRS_TRAINING
